...
oc secrets new-dockercfg docker-registry --docker-server=docker-registry-default.apps.dwojciec.com --docker-username=admin --docker-password=$(oc whoami -t) --docker-email=test@test.com
